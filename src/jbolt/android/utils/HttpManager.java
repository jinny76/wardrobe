...
public class HttpManager {
    ...
    public static Drawable getImage(String url, Map<String, String> params, HttpClient client)
        ...
        try {
            ...
            if (statusCode == HttpStatus.SC_OK) {
                ...
                byte[] content = ObjectUtilities.transformInputStream(is);
                ByteArrayInputStream bis = new ByteArrayInputStream(content);
                result = new BitmapDrawable(BitmapFactory.decodeStream(bis));
                //result = Drawable.createFromStream(bis, "src");
            } else {
                throw new DeviceRuntimeException("Network error!");
            }
        } catch (IOException e) {
    ...
    protected static File download(HttpEntity httpEntity, String fileName) throws IOException {
        ...
        try {
            ...
            if (is != null) {
                file = new File(SDCardUtilities.getRootDir(), fileName);
