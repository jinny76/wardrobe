...
public class StringUtilities {
    ...
    public static String leftPad(String strInput, int intLength, char padingChar) {
        if (intLength > strInput.length()) {
            ...
            try {
                ...
                Log.e(StringUtilities.class.getName(), ObjectUtilities.printExceptionStack(e));
            }
            return null;
        } else {
            return strInput;
     ...
     */
    public static String combineString(List inputList, String token) {
        if (inputList == null) {
            return null;
        }
        StringBuffer sb = new StringBuffer();
    ...
    public static String recoverIllegalPropertyName(String illegalPropertyName) {
        ...
        if (illegalPropertyName.indexOf(" ") != -1
                || illegalPropertyName.indexOf("_") != -1
                || illegalPropertyName.indexOf("-") != -1) {
    ...
    public static String[] deleteDuplicatedString(String[] stringArray) {
        ...
        for (String s : stringArray) {
            if (!isEmpty(s) && !uniqueAccounts.contains(s))
