...
/**
 * <p>Title: MyShowListAdapter</p>
 * <p>Description: MyShowListAdapter</p>
 * <p>Copyright: Copyright (c) 2003</p>
 * <p>Company: IPACS e-Solutions (S) Pte Ltd</p>
 *
 * @author feng.xie
 */
public class MyShowListAdapter extends BaseListAdapter implements View.OnTouchListener {

    private List<Collocation> items = new ArrayList<Collocation>();
    private Context context;
    private int upX;
    private int downX;
    private View.OnClickListener deleteListener;

    public MyShowListAdapter(Context context) {
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        ViewHolder holder;
        Collocation item = (Collocation) getItem(i);
            ...
            holder.pic.setOnClickListener(
                    new View.OnClickListener() {
                        public void onClick(View view) {
                            Collocation item = (Collocation) view.getTag();
    ...
    public void setItems(List<Collocation> items) {
        this.items = items;
    }
